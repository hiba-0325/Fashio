        ...
        <div className="login-signup w-full min-h-screen pt-16 pb-20">
          <form onSubmit={handlerEvent}>
            <div className="login-cont w-[90%] max-w-[580px] h-auto bg-white m-auto px-6 py-10 md:px-10 md:py-14">
              ...
              <hr className="border-t-4 border-b-2 border-l border-[#489bb7]" />
              <br />
              <div className="loginsignup-fields flex flex-col gap-6">
                ...
                <div className="relative">
                  ...
                  />
                  <span
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-[#489bb7]"
              ...
              <button className="w-full h-14 md:h-16 text-white bg-[#489bb7] hover:bg-[#2d6d82] focus:ring-4 focus:ring-blue-300 mt-6 text-xl md:text-2xl font-medium">
                Continue
              </button>
              <p className="loginsignup-login mt-5 text-[#5c5c5c] text-base md:text-lg font-medium">
                Already have an account?
                <NavLink to="/login">
                  <button className="text-[#3a70d3] font-semibold">
                    Login here
                  </button>
                </NavLink>
              </p>
